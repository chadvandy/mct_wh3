...
function mct_section:get_localised_text()
    return GLib.HandleLocalisedText(self._text, "Default Section", "mct_"..self:get_mod():get_key().."_"..self:get_key().."_section_text")
end
...
function mct_section:get_tooltip_text()
    return GLib.HandleLocalisedText(self._tooltip_text, "", "mct_"..self:get_mod():get_key().."_"..self:get_key().."_section_tooltip_text")
end
...
function mct_section:get_description()
    return GLib.HandleLocalisedText(self._description, "", "mct_"..self:get_mod():get_key().."_"..self:get_key().."_section_description")
end
